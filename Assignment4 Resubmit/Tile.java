...
public class Tile {
    ...
    public Tile(int x, int y) {
        ...
        this.y = y;
        if (tileImage == null) {
            tileImage = View.loadImage("images/tile.jpg");
        }
    }

    void drawTile(Graphics g, int scrollX, int scrollY) {
        g.drawImage(tileImage, this.x - scrollX, this.y - scrollY, this.width, this.height, null);
    }
